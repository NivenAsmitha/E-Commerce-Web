...
const Menu = [
  ...
  { id: 3, name: "Women Wear", link: "/womenwear" },
  { id: 4, name: "Mens Wear", link: "/menswear" },
  { id: 5, name: "About Us", link: "/about" },
];

const DropdownLinks = [
  { id: 1, name: "Foot Wear", link: "/footwear" },
  { id: 2, name: "Hats & Caps", link: "/caps" },
  { id: 3, name: "Bags", link: "/bag" },
];
        ...
        <div className="container mx-auto flex justify-between items-center py-2">
          ...
          <div className="relative flex items-center gap-3">
            ...
            <div className="relative group hidden sm:block">
              ...
              />
              <IoMdSearch
                className="text-gray-500 hover:text-primary absolute top-1/2 left-3 -translate-y-1/2 text-xl cursor-pointer"
