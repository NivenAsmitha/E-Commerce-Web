...
import BagBanner from "../assets/website/bag.jpg"; // Update the path if needed
...
export default function Bag({ handleAddToCart }) {
  ...
  useEffect(() => {
    fetch("http://localhost/kaizen-backend/bag_api.php")
      .then((res) => res.json())
  ...
  const addToCartAndClose = () => {
    ...
    // Call handleAddToCart prop (from App.jsx)
    handleAddToCart({
      ...selectedProduct,
      size: selectedSize,
      quantity,
